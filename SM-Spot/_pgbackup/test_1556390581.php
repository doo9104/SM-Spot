        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="span9">
                    <div align="right">
                        <ui>
                            <a id="view" class="button" href="#">자세히 보기</a>
                        </ui>
                    </div>
                    <br>
                    <div class="row">
                        <section id="projects">
                            <ul id="thumbs">
                                ...
                                <li class="item-thumbs span3 design">
                                    <!-- Fancybox - Gallery Enabled - Title - Full Image -->
                                    <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="The Office" href="_include/img/work/full/image-02-full.jpg"> <span class="overlay-img"></span> <span class="overlay-img-thumb font-icon-plus"></span> </a>
                                    <!-- Thumb Image and Description -->
