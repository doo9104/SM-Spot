...
<head>
    ...
    <!-- Analytics -->
    <!-- 별점-->
    <link href="_include/rating/css/Raiting_style.css" rel="stylesheet">
...
<body>
    ...
    <header>
        <div class="sticky-nav">
            ...
            <div id="logo">
                <a id="goUp" href="#home-slider" title="">Brushed Template</a>
            </div>
...
?>
		 ...
		 <nav id="menu">
                <ul id="menu-nav">
                    ...
                    <li>
                        <a href="login.php" class="external">로그인</a>
                    </li>
                    <li>
                        <a href="join.php" class="external">회원가입</a>
                    </li>
                    <li>
...
<!--위 메뉴 부분-->
		 <nav id="menu">
                <ul id="menu-nav">
                    ...
                    <li>
                        <a href="logout.php" class="external">로그아웃</a>
                    </li>
                    <li>
                        <a href="shortcodes.html" class="external">Shortcodes</a>
                    </li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="span12">
                    <div class="title-page">
                        <h2 class="title">세명스팟</h2>
                        <h3 class="title-description">세명대학교 주변 시설들의 정보와 평가가 한눈에</h3>
                    </div>
                </div>
            </div>
            <!-- End Title Page -->
            ...
            <div class="row">
                <div class="span3">
                    ...
                    <nav id="options" class="work-nav">
                        <ul id="filters" class="option-set" data-option-key="filter">
                            ...
                            <li>
                                <a href="#filter" data-option-value="*" class="selected">전체보기</a>
                            </li>
                            <li>
                                <a href="#filter" data-option-value=".restaurant">음식점</a>
                            </li>
                            <li>
                                <a href="#filter" data-option-value=".life">생활서비스</a> <!--photography -->
                            </li>
                            <li>
                                <a href="#filter" data-option-value=".culture">문화시설</a> <!--video-->
                            </li>
                        </ul>
                    </nav>
                    <!-- End Filter -->
                ...
                <div class="span9">
                    <div align="right">
                        <ui>
                            <a id="view" class="button" href="http://localhost/test.php">자세히 보기</a>
                    ...
                    <div class="row">
                        <section id="projects">
                            <ul id="thumbs">
                                ...
                                <li class="item-thumbs span3 restaurant">
                                    <!-- Fancybox - Gallery Enabled - Title - Full Image -->
                                    <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="아톰" href="_include/img/work/full/image-01-full.jpg"> <span class="overlay-img"></span> <span class="overlay-img-thumb font-icon-plus"></span> </a>
                                    <!-- Thumb Image and Description -->
                                    <img  src="_include/img/work/thumbs/image-01.jpg" alt="블라블라블라블라">
                                   
                                </li>
                                <!-- End Item Project -->
                                <!-- Item Project and Filter Name -->
                                <li class="item-thumbs span3 culture">
                                    <!-- Fancybox - Gallery Enabled - Title - Full Image -->
                                    <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="SM동전노래연습장" href="_include/img/work/full/image-02-full.png"> <span class="overlay-img"></span> <span class="overlay-img-thumb font-icon-plus"></span> </a>
                                    <!-- Thumb Image and Description -->
                                    <img src="_include/img/work/thumbs/image-02.png" alt="SM동전노래연습장">
                                </li>
                                <!-- End Item Project -->
                                <!-- Item Project and Filter Name -->
                                <li class="item-thumbs span3 photography">
                                    <!-- Fancybox - Gallery Enabled - Title - Full Image -->
                                    <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="The Mountains" href="_include/img/work/full/image-03-full.jpg"> <span class="overlay-img"></span> <span class="overlay-img-thumb font-icon-plus"></span> </a>
                                    <!-- Thumb Image and Description -->
                                ...
                                <li class="item-thumbs span3 photography">
                                    <!-- Fancybox - Gallery Enabled - Title - Full Image -->
                                    <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="The Sea" href="_include/img/work/full/image-04-full.jpg"> <span class="overlay-img"></span> <span class="overlay-img-thumb font-icon-plus"></span> </a>
                                    <!-- Thumb Image and Description -->
                                ...
                                <li class="item-thumbs span3 photography">
                                    <!-- Fancybox - Gallery Enabled - Title - Full Image -->
                                    <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Clouds" href="_include/img/work/full/image-05-full.jpg"> <span class="overlay-img"></span> <span class="overlay-img-thumb font-icon-plus"></span> </a>
                                    <!-- Thumb Image and Description -->
                                ...
                                <li class="item-thumbs span3 design">
                                    <!-- Fancybox - Gallery Enabled - Title - Full Image -->
                                    <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="The Dark" href="_include/img/work/full/image-06-full.jpg"> <span class="overlay-img"></span> <span class="overlay-img-thumb font-icon-plus"></span> </a>
                                    <!-- Thumb Image and Description -->
                                ...
                                <li class="item-thumbs span3 design">
                                    <!-- Fancybox - Gallery Enabled - Title - Full Image -->
                                    <a class="hover-wrap fancybox" data-fancybox-group="gallery" title="The Beach" href="_include/img/work/full/image-07-full.jpg"> <span class="overlay-img"></span> <span class="overlay-img-thumb font-icon-plus"></span> </a>
                                    <!-- Thumb Image and Description -->
            ...
            <div class="row">
                ...
                <div class="span4 profile">
                    ...
                    <p class="profile-description">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ac augue at erat <a href="#">hendrerit dictum</a>.
                ...
                <div class="span12">
                    <nav id="social">
                        <ul>
                            ...
                            <li>
                                <a href="http://forrst.com/people/Bluxart" title="Follow Me on Forrst" target="_blank"><span class="font-icon-social-forrst"></span></a>
                            </li>
                            <li>
                                <a href="http://www.behance.net/alessioatzeni" title="Follow Me on Behance" target="_blank"><span class="font-icon-social-behance"></span></a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="http://themeforest.net/user/Bluxart" title="Follow Me on ThemeForest" target="_blank"><span class="font-icon-social-envato"></span></a>
                            </li>
                            <li>
                                <a href="http://zerply.com/Bluxart/public" title="Follow Me on Zerply" target="_blank"><span class="font-icon-social-zerply"></span></a>
                            </li>
                        </ul>
                    </nav>
                </div>
